...
keys=("APP_URL" "REDIS_PASSWORD" "MAIL_HOST" "MAIL_USERNAME" "MAIL_PASSWORD" "DB_PASSWORD" "WECHAT_APP_ID" "WECHAT_SECRET" "GIT_CLIENT_ID" "GIT_SECRET" "WECHAT_PUBLIC_APP_ID" "WECHAT_PUBLIC_SECRET" "GMAP_KEY" "APP_KEY" "BAIDU_TOKEN" "MAIL_PORT" "DB_DATABASE" "ASSET_URL" "WEIXIN_MINI_APP_ID" "WEIXIN_MINI_SECRET")
