...
class XyArticle extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('ALTER TABLE `xy_article` ADD FULLTEXT index article_full_text_index(title, content)');
        DB::statement('ALTER TABLE `xy_article` ADD FULLTEXT index article_keywords(keywords)');
    }
